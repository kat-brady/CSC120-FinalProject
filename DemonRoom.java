 ...
 * int saltLeft assesses how much salt remains in the shaker
...
public class DemonRoom extends Room{
    ...
    public void attack(){
        ...
        if(!isDefeated && Player.player.health>0){
            ...
            }else if (attackMethod.contains("holy water") && attackMethod.contains("heal") && holyWaterLeft>0){
            ...
            }else if(attackMethod.contains("holy water")&& !attackMethod.contains("heal") && holyWaterLeft==0 && Player.player.hasItemInInventory(SuppliesRoom.bottle)){
                javaelithHealth-=5;
